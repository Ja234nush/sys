...
som = MiniSom(1, N_neurons, 2, sigma=1, learning_rate=0.2, neighborhood_function='gaussian', random_seed=0)
points = np.array([x, y]).T
som.random_weights_init(points)

plt.figure(figsize=(10, 9))
total_iter = 0
for i, iterations in enumerate(range(10, 500, 40)): # note: increasing training periods
